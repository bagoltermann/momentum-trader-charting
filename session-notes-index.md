...
|------|--------|-------------|--------|
| 2026-01-28 | Warrior Trading Chart Enhancements + Stability Fixes | Gap % badge, volume badge, D1 High breakout alert, streaming relay fallback, zero candle filtering, httpx timeout wrapper | ✅ Complete |
