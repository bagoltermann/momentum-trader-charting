...
| Hash | Message |
|------|---------|
| `pending` | fix: Force IPv4 to avoid IPv6 connection hangs on Windows |
...
## Next Steps
- Monitor for additional hang occurrences after Fix #12
- If stable for 1+ hour, consider this issue resolved
